...
const ARTICULOS: PosGebHelpArticle[] = [
  ...
  },
  {
    ...
    summary: "Resumen de ventas, monitoreo por rango de fecha/hora y sincronización con la nube.",
    pasos: [
      "Menú «Reportes».",
      "Revisá totales del día (Hoy / Ayer / otro día) y productos más vendidos.",
      "En «Monitoreo por rango de fecha y hora» elegí desde/hasta con hora exacta (Colombia); usá atajos como «Turno abierto» o «Última hora».",
      "Tocá una venta en la tabla para ver productos; con «PDF / correo» descargás o enviás el informe.",
      "Si algo no cuadra, pulsá «Actualizar» para traer ventas de la nube.",
    ],
    keywords: [
      "reporte",
      "reportes",
  ...
  },
  {
    ...
    summary: "Total cobrado en el turno actual, visible debajo del catálogo.",
    pasos: [
      "En «Ventas e ingresos», debajo del catálogo está «Venta acumulada del turno».",
      "Muestra la suma de cobros confirmados en esta caja desde que abriste el turno (todas las pre-cuentas).",
      "Se actualiza solo con cada venta; con turno cerrado abrí turno de nuevo para acumular desde cero.",
    ],
    keywords: ["venta acumulada", "total turno", "ventas turno", "acumulado", "total del día", "caja"],
    moduloSugerido: "ventas",
