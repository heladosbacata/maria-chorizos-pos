...
export default function ContratoPosGebPanel({ onVolver }: ContratoPosGebPanelProps) {
  ...
  const [reinicioClaveVisible, setReinicioClaveVisible] = useState(false);
            ...
            <div className="mt-4">
              ...
              <div className="relative">
                <input
                  ...
                  type={reinicioClaveVisible ? "text" : "password"}
                  autoComplete="off"
                  value={reinicioClave}
                  onChange={(e) => {
                  ...
                  className="w-full rounded-lg border border-gray-600 bg-gray-900 py-2.5 pl-3 pr-11 text-sm text-white placeholder:text-gray-600 focus:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-500/30"
                  placeholder="••••••"
                />
                <button
                  type="button"
                  onClick={() => setReinicioClaveVisible((v) => !v)}
                  className="absolute right-1 top-1/2 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-lg text-gray-400 hover:bg-gray-800 hover:text-gray-100"
                  aria-label={reinicioClaveVisible ? "Ocultar clave" : "Mostrar clave"}
                  title={reinicioClaveVisible ? "Ocultar clave" : "Mostrar clave"}
                >
                  {reinicioClaveVisible ? (
